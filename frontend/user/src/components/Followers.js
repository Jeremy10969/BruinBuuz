        ...
        <h4>Followers</h4>
        {
            ...
            followersBlogList.map(
                (obj)=>(
                        ...
                        <div className='follower-list' key={obj.user._id}>
                            <h5>
                                ...
                                {location.pathname.substring(0,5)=='/user'?"":<label for="remove-follower"><i className='material-icons' onClick={()=>{setRemoveFollower(obj.user._id)}}>remove_circle_outline</i></label>}
